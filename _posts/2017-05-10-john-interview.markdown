...
Here are the last few questions from the standard set.  After these, I can stitch together a transcript and run it by you (if you are comfortable with me posting.  Otherwise, no worries!)  Sounds good.
